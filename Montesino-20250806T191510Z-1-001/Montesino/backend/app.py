...
import pymysql # type: ignore # permite la interacción con bases de datos MySQL escrito completamente en Python
...
def consulta_general():
    try: 
        conn = conectar('localhost', 'root', '', 'gestor_contrasenas')
        cur = conn.cursor()
